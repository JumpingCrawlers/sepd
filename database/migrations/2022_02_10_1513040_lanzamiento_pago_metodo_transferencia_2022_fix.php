...
class LanzamientoPagoMetodoTransferencia2022Fix extends Migration
{
    /**
     * 3ways - Euro Fuenmayor
     * Migración requerida fix lanzamiento de pago 2022 - Forma de pago: Transferencia
     * Run the migrations.
     *
     * @return void
     */
...

    {
        ...
        $usuarios_que_pagan_via_transferencia_con_estado_pago_2022_ya_creado = DB::table('usuarios_pagos')
            ...
            ->where('usuarios_socios.socios_pagos_metodos_id', 3)
        ...
        \Illuminate\Support\Facades\Log::debug('$usuarios_pendientes_de_pagar_via_transferencias fix 2022-10-02 count: '.print_r($usuarios_pendientes_de_pagar_via_transferencias->count(),true));
    }
