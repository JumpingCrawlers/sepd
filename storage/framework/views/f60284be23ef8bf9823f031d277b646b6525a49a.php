...
<head>
    ...
    <meta name="author" content="<?php echo e(setting('site.autor')); ?>">
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('favicon.ico')); ?>?v=20240103">
    <!-- CSRF Token. -->
    ...
    <link href="<?php echo e(asset('css/app.css')); ?>?v=20240132" rel="stylesheet">
    <link href="<?php echo e(asset('css/sepd.css')); ?>?v=20240133" rel="stylesheet">
    ...
    <?php if((isset($_COOKIE[config('cookie-consent.cookie_name')]) && strpos($_COOKIE[config('cookie-consent.cookie_name')], config('cookie-consent.cookies-analiticas')) !== false) || 
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PB54WWFR"
    ...
    <?php echo $__env->make('puzzle.cabecera', ['flash' => $flash], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('puzzle.menu_principal', ['esSocio' => $esSocio], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('puzzle.menu_seccion', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('puzzle.breadcrumb', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <main role="main">
        ...
        <?php echo $__env->yieldContent('pastillas'); ?>
        
        
        <?php if(isset($pagina) && isset($pagina->posicion_destacados) && $pagina->posicion_destacados): ?>
    ...
    <?php echo $__env->make('puzzle.pie', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            <?php if(\Illuminate\Support\Facades\Auth::check() && \App\UsuarioSocio::where('usuario_id', \Illuminate\Support\Facades\Auth::id())->first()): ?>
                if(urlEle.length > 0){
                    urlEle.attr('href', 'https://manualdigestivosepd.es/loginin/?token=<?php echo e(( $sso_token ?? '')); ?>')
            ...
            <?php if(isset($felicitacion_navidad) && $felicitacion_navidad == 'on'): ?>
                <?php if(isset($pagina) && $pagina->slug == 'inicio'): ?>
    ...
    <?php if(! isset($cabecera_sin_acceso_usuarios)): ?>

        <?php if(auth()->guard()->guest()): ?>

            
            <?php echo $__env->make('puzzle.modal_login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

            
            <?php if(isset($errors) && $errors->has('email') && ! isset($cabecera_sin_acceso_usuarios)): ?>
                <script>
        ...
        <?php else: ?>
            ...
            <?php echo $__env->make('puzzle.modal_user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php endif; ?>

    <?php endif; ?>
    
    <?php echo $__env->make('puzzle.modal_video', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('puzzle.modal_imagen', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    
    <?php if(isset($felicitacion_navidad) && $felicitacion_navidad == 'on'): ?>
        <?php echo $__env->make('puzzle.modal_navidad', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>

    
    <?php echo $__env->make('puzzle.modal_sso_no_auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php if(request()->is('inicio')): ?>
        <?php if ($__env->exists('puzzle.popup')) echo $__env->make('puzzle.popup', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    
</body>
</html>
<?php /**PATH C:\laragon\www\sepd.es\resources\views/puzzle/master.blade.php ENDPATH**/ ?>