    ...
    <div>
        <div class="modal-popup" id="imageModal">
            <div class="modal-popup-content">
                ...
                <img src="<?php echo e(asset('storage/' . $popup->image)); ?>" class="modal-popup-image">
            </div>
        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\sepd.es\resources\views/puzzle/popup.blade.php ENDPATH**/ ?>