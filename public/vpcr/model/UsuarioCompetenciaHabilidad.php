<?php 
/**
 * Clase Usuario Competencia Habilidad
 *
 * @return void
 */
class UsuarioCompetenciaHabilidad {
    ...
    /**
     * Constructor de la Clase Usuario Competencia Habilidad
     *
     * @return void
     */
    ...
    /**
     * Insert de usuarios competencias Habilidad
     *
     * @return void
     */
    public function create_usuario_competencia_habilidades($objeto){
        $instance = DataBase::getInstance();
        $conn = $instance->getConnection();
        ...
        if( $num_rows > 0): // Si la relacion existe simplemente se asgina esta aptitud a esa relacion
            ...
            $sql = "INSERT INTO {$instance->tableUsuariosCompetenciasHabilidades}(archivo, usuarios_vpcrs_competencias_id, created_at) VALUES('{$archivo}', {$usuarios_competencias_id}, '{$created_at}')";
            $query = mysqli_query($conn, $sql);
    ...
    /**
     * Update de usuarios competencias Habilidad
     *
     * @return void
     */
    public function update_usuario_competencia_habilidad($objeto){
        $instance = DataBase::getInstance();
        $conn = $instance->getConnection();
        ...
        $sql = "UPDATE {$instance->tableUsuariosCompetenciasHabilidades} SET archivo = '{$archivo}', updated_at = '{$updated_at}' WHERE id = {$id}";
        $query = mysqli_query($conn, $sql);
