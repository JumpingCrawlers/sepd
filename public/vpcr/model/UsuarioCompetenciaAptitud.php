<?php 
/**
 * Clase Usuario Competencia Aptitud
 *
 * @return void
 */
class UsuarioCompetenciaAptitud {
    ...
    /**
     * Constructor de la clase Usuario Competencia Aptitud
     *
     * @return void
     */
    ...
    /**
     * Insert de usuarios competencias aptitudes
     *
     * @return void
     */
    public function create_usuario_competencia_aptitudes($objeto){
        $instance = DataBase::getInstance();
        $conn = $instance->getConnection();
        ...
        if($num_rows > 0): // Si la relacion existe simplemente se asgina esta aptitud a esa relacion
            ...
            $sql = "INSERT INTO {$instance->tableUsuariosCompetenciasAptitudes}(archivo, usuarios_vpcrs_competencias_id, created_at) VALUES('{$archivo}', {$usuarios_competencias_id}, '{$created_at}')";
            $query = mysqli_query($conn, $sql);
    ...
    /**
     * Update de usuarios competencias aptitudes
     *
     * @return void
     */
    public function update_usuario_competencia_aptitud($objeto){
        $instance = DataBase::getInstance();
        $conn = $instance->getConnection();
        ...
        $sql = "UPDATE {$instance->tableUsuariosCompetenciasAptitudes} SET archivo = '{$archivo}', updated_at = '{$updated_at}' WHERE id = {$id}";
        $query = mysqli_query($conn, $sql);
