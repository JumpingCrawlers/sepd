        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                <p class="font-weight-bold">
                    Contenido exclusivo para usuarios registrados en el site. Si ya estás registrado, por favor, accede <a href="{{ route('login') }}">aquí</a> e introduce tu mail y contraseña, y vuelve a intentar acceder a este enlace. Si aún no estás registrado, completa nuestro Formulario de registro.
                </p>
                <button type="button" class="btn mt-2" {{ getHtmlEstiloBoton() }} data-dismiss="modal" aria-label="Close">
                    Cerrar
                </button>
