    ...
    <div class="row">
        <div class="col-sm-4 col-lg-3 mb-3 @if(isset($pagina->contenido_extra_flotante) && $pagina->contenido_extra_flotante) flotante @endif">
            ...
            <form name="formFiltros" id="formFiltros" method="POST">
                ...
                <div class="container">
                    @include('puzzle.filtros.prensa_anyos')
                </div>
        ...
        <div class="col-sm-8 col-lg-9 pl-3">
            <div class="container" id="contenidoVue">
                ...
                <prensa-index ref="PrensaIndex" url='{{ config('app.url') }}' url-back='{{ config('app.url_back') }}' iconos='{{ $iconos }}'>
...
@section('scripts')
    ...
    {{-- JS específico para prensa --}}
    <script src="{{ asset('js/prensa.js') }}"></script>
@endsection