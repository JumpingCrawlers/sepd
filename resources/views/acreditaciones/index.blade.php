                ...
                <div class="row">
                    <div class="col-12" style="margin-bottom: 30px;">
                        <li id="head">
                            ...
                            <div id="radios">
                                <div id="link" href="{{ Request::is('acreditaciones/presencial') ? '#' : route('acreditaciones') . '/presencial' }}" class="custom-control custom-radio">
                                    <input type="radio" id="radio1" data-id="presencial" name="radio-btn" class="custom-control-input" {{ Request::is('acreditaciones/presencial') ? 'checked' : '' }}>
                                    <label class="custom-control-label" for="radio1">Congreso SEPD</label>
                                </div>
                                <div id="link" href="{{ (Request::is('acreditaciones') || Request::is('acreditaciones/online')) ? '#' : route('acreditaciones') . '/online' }}" class="custom-control custom-radio">
                                    <input type="radio" id="radio2" data-id="online" name="radio-btn" class="custom-control-input" {{ (Request::is('acreditaciones') || Request::is('acreditaciones/online')) ? 'checked' : '' }}>
