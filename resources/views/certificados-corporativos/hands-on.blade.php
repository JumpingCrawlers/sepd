                ...
                <td class="content">
                    <div class="certificado">
                        <!--div class="titulo text-center">
                            <strong>CERTIFICADO DE PROFESOR</strong>
                        </div-->
                        ...
                        <div class="contenido">
                            ...
                            <p class="no-break">
                                Con NIF <span class="resaltado">{{ $dni }}</span> ha colaborado como profesor/a en  
                                <span class="resaltado">{{ $nombre_sesion }}</span> durante el 
                                <span class="resaltado">{{ $nombre_congreso }}</span> celebrado en 
                                <span class="resaltado">{{ $lugar_fecha_congreso }}.</span>
                            </p>
