                ...
                <td class="content">
                    <div class="certificado">
                        <!--div class="titulo text-center">
                            <strong>CERTIFICADO DE EVALUADOR</strong>
                        </div-->
                        ...
                        <div class="contenido">
                            ...
                            <p class="no-break">
                                Con NIF <span class="resaltado">{{$dni}}</span> ha colaborado como <span class="resaltado">Evaluador/a</span> de las comunicaciones científicas del área de <span class="resaltado">{{ $area_con }}</span> en el <span class="resaltado">{{ $nombre_congreso }}</span> que tuvo lugar en <span class="resaltado">{{ $lugar_fecha_congreso }}</span>.
                            </p>
