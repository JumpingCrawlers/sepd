        ...
        <div class="col-10 offset-1">
            ...
            <form id="form_cookies">
                ...
                <div class="form-check mb-2">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-3">
                            ...
                            <input class="form-check-input" type="checkbox" value="{{config('cookie-consent.cookies-tecnicas')}}" id="cookiesTecnicas" checked disabled>
                    ...
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-3">
                            ...
                            <input class="form-check-input" type="checkbox" value="{{config('cookie-consent.cookies-internas')}}" id="cookiesInternas" checked>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-check mb-3">
                    <div class="row d-flex justify-content-center">
                        ...
                        <div class="col-3">
                            ...
                            <input class="form-check-input" type="checkbox" value="{{config('cookie-consent.cookies-analiticas')}}" id="cookiesAnaliticas" checked>
                                <span class="slider round"></span>
                            </label>
                        </div>
                    </div>
                ...
                <div class="form-group row justify-content-center">
                    <button type="submit" class="btn"{{ getHtmlEstiloBoton('', '') }}>Guardar</button>
                </div>
            </form>
        </div>
    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if (window.jQuery) {
            $("#form_cookies").submit(function( event ) {
                ...
                setCookie('{{ config('cookie-consent.cookie_name') }}', cValue, {{ config('cookie-consent.cookie_lifetime') }});
            ...
            function checkCookies(cValue) {
                ...
                if(!cValue.includes('{{config('cookie-consent.cookies-internas')}}')){
        
                    let nombres = '{{ json_encode(config('cookie-consent.cookies-internas-nombres')) }}';
                ...
                if(!cValue.includes('{{config('cookie-consent.cookies-analiticas')}}')){
        
                    let nombres = '{{ json_encode(config('cookie-consent.cookies-analiticas-nombres')) }}';
                    nombres = nombres.replace(/&quot;/g, '');
                    nombres = nombres.replace('[', '');
                    nombres = nombres.replace(']', '');
