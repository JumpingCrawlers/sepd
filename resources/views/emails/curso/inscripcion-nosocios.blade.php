...
<p class="MsoNormal" style="margin-top: 10px; margin-right:0cm; margin-left: 0cm; margin-bottom: 0.0001pt; font-size:11pt; ">
    Estimado/a <b>{{ $usuario->nombre_completo }}</b> <br />
    Su inscripci&oacute;n al curso <b>{{ $curso_titulo }}</b> se ha realizado correctamente.<br />
    Le agradecemos su inter&eacute;s y confianza en la plataforma online de la SEPD y le recordamos que estamos a su disposici&oacute;n para resolver cualquier duda o sugerencia que desee plantearnos.<br />
    Un cordial saludo</p><br />
<p class="MsoNormal" style="margin-top: 10px; margin-right:0cm; margin-left: 0cm; margin-bottom: 0.0001pt; font-size:11pt; ">
